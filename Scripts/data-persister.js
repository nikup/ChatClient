...
ChatClient.persisters = (function () {
    ...
    var GamePersister = Class.create({
        ...
        /*getState: function (gameId) {
            return httpRequester.getJson(this.serviceRootUrl + gameId + "/state/" + this.userPersister._getSessionKey());
        }*/
    });
    ...
    /*var GuessPersister = Class.create({
        ...
        // TODO taka li e ili trqbva i parola
        make: function (guessNumber, gameId) {
            return httpRequester.postJson(this.serviceRootUrl + "make/" + this.userPersister._getSessionKey(), {
                gameId: gameId,
                number: guessNumber
            });
        }

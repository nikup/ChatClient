...
ChatClient.controller = (function () {
    var AccessController = Class.create({
        init: function (dataPersister, controlerContainer) {
            ...
            ChatClient.ui.generateLoginButtons(this.controlerContainer);
        },
        ...
        //         self.scoresGrid = new ChatClient.ui.GridViewControl();
        ...
        handleLoginProcedure: function (deferred) {
            ...
            loginControler.on('click', function () {
                ...
                ChatClient.ui.generateLoginForm("#login-container");
                $('#btn-login').on('click', function () {
                    ...
                    self.persister.user.login(username, password).then(function (data) {
                        $("#user-nickname").text("Hi, " + data.username);
            ...
            registerControler.on('click', function () {
                $("#login-container").hide();
                $("#register-container").hide();
                ChatClient.ui.generateRegisterForm("#register-container");
                $('#btn-register').on('click', function () {
                    var username = $("#register-username-input").val().escape();
                    var password = $("#register-password-input").val().escape();
                    self.persister.user.register(username, password).then(function (data) {
                        $("#user-nickname").text("Hi, " + data.username);
                        self.toggleLoginButtons();
                        deferred.resolve();
                    }, function (error) {
    ...
    var GameController = Class.create({
        init: function (dataPersister, controlerContainer) {
            ...
            //this.openGamesList = new ChatClient.ui.ListControl();
            //this.activeGamesList = new ChatClient.ui.ListControl();
            //this.createdGamesList = new ChatClient.ui.ListControl();
            //this.createGameControl = new ChatClient.ui.CreateGameControl();
            //this.messagesList = new ChatClient.ui.ListControl();
            //this.battleControl = new ChatClient.ui.BattleControl();
        ...
        attachHandlers: function () {
            ...
            this.openGamesList.attachItemClickHandler(function (itemData) {
                if (self._joinGameIndex != itemData.itemIndex) {
                    ...
                    self.joinGameControl = new ChatClient.ui.JoinGameControl();
